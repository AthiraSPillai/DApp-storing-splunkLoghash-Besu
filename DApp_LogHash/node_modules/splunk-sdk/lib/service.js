...
(function() {
    ...
    var Context     = require('splunk-sdk/lib/context');
    var Http        = require('splunk-sdk/lib/http');
    var Async       = require('splunk-sdk/lib/async');
    var Paths       = require('splunk-sdk/lib/paths').Paths;
    var Class       = require('splunk-sdk/lib/jquery.class').Class;
    var utils       = require('splunk-sdk/lib/utils');
