...
var Async = require('splunk-sdk/lib/async');

var ModularInputs = {
    utils: require("splunk-sdk/lib/modularinputs/utils"),
    ValidationDefinition: require('splunk-sdk/lib/modularinputs/validationdefinition'),
    InputDefinition: require('splunk-sdk/lib/modularinputs/inputdefinition'),
    Event: require('splunk-sdk/lib/modularinputs/event'),
    EventWriter: require('splunk-sdk/lib/modularinputs/eventwriter'),
    Argument: require('splunk-sdk/lib/modularinputs/argument'),
    Scheme: require('splunk-sdk/lib/modularinputs/scheme'),
    ModularInput: require('splunk-sdk/lib/modularinputs/modularinput'),
    Logger: require('splunk-sdk/lib/modularinputs/logger')
};
